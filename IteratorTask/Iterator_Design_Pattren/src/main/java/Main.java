...
public class Main {
    public static void main(String[] args) {
        ...
        Age_Iterator iter = new Age_Iterator(Or1);
       while(!iter.isDone())
       {
           System.out.println(iter.currentItem().Name+" age "+iter.currentItem().Age);
           iter.next();
        }
       ...
       /*   
        for(Age_Iterator iter = new Age_Iterator(Or1); iter.hasNext();){
            iter.next();
       ...
       while(!iter.isDone())
       {
        ...
        System.out.println(count+"\t"+iter.currentItem().Name+" age "+iter.currentItem().Age);
         iter.next();
         count++;
       }
*/
